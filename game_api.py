...
class Game_api:
    ...
    def run_game(self):
        ...
        self.api.send_chat_message(self.game_id, "player", "Welcome to the game friend.")
        self.api.send_chat_message(self.game_id, "player", "Try to beat me :)")
        ...
        self.api.send_chat_message(self.game_id, "player", "Hey GG!")
        self.api.send_chat_message(self.game_id, "player", "Well Played")
